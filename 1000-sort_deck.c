 ...
 * Return: Positive if s1 > s2, 0 if s1 == s2, negative if s1 < s2.
 */
int _strcmp(const char *s1, const char *s2)
{
	while (*s1 && *s2 && *s1 == *s2)
...
/**
 * insertion_sort_deck_kind - Sorts a deck by kind.
...
/**
 * insertion_sort_deck_value - Sorts a deck by value.
 * @deck: Pointer to the deck.
 */
void insertion_sort_deck_value(deck_node_t **deck)
{
...
/**
 * sort_deck - Sorts a deck by kind and value.
 * @deck: Pointer to the deck.
 */
void sort_deck(deck_node_t **deck)
{
